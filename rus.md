...
* выполненные: Действие, относящееся к промису, удалось успешно выполнить.

* отклоненные: Действие, относящееся к промису, не удалось выполнить.

* ожидающие: Еще не выполненные или не отклоненные.

* отработанные: Промисы, которые были выполнены или отклонены.

Так же в спецификации есть термин **с возможность последующей обрабтки**. Это объект, похожий на промис, но имеющий метод "then". Я постараюсь использовать его как можно реже.
