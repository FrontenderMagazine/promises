...
…и, кроме того, если что-то пойдет не так, сообщить пользователю об ошибке. А так же, в момент ошибки необходимо будет скрыть прелоадер, иначе, рано или поздно это вызовет у пользователя кинетоз.
